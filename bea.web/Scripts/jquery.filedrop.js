...
;(function($) {
  ...
  var default_opts = {
      ...
      errors = ["Naviguateur non supporté ! Essayez Chrome ou Firefox ;)", "Trop d'images! La limite est de 5", "Une de vos images est trop grosse!<br> 1Mo maximum par image.", "Ce type de fichier n'est pas supporté.<br>Seuls jpg, png et gif sont autorisés.", "Fichier introuvable.", "Impossible de lire le fichier.", "AbortError", "Problème de lecture du fichier."],
